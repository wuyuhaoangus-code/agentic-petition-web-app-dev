-- ============================================
-- Add category and content_hash columns WITHOUT CHECK constraint
-- Allows any category value for maximum flexibility
-- ============================================
-- Run this in Supabase SQL Editor

-- 1. Add category column WITHOUT CHECK constraint
...
COMMENT ON COLUMN user_files.category IS 'File category: flexible field, can be any string value. Common values: evidence, degrees, certificates, employment, futurePlan, others, form';
